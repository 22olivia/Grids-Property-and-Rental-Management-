...
## Wire a Next.js / Vercel frontend

```env
# Demo (no Railway):
NEXT_PUBLIC_API_URL=/api/v1

# Real Laravel API on Railway (MySQL):
NEXT_PUBLIC_API_URL=https://YOUR-RAILWAY-API.up.railway.app/api/v1
```

Redeploy Vercel after changing `NEXT_PUBLIC_*` vars.

Full Railway MySQL steps: [`RAILWAY.md`](./RAILWAY.md).
