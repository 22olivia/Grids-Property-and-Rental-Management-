...
class OrganizationController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        ActivityLog::record('organization.created', $org, $validated, $request);
    ...
    public function update(Request $request, Organization $organization): JsonResponse
    {
        ...
        ActivityLog::record('organization.updated', $organization, $validated, $request);
    ...
    public function destroy(Organization $organization): JsonResponse
    {
        ...
        ActivityLog::record('organization.deleted', $organization, ['name' => $organization->name]);
        $organization->delete();
    ...
    public function assignUser(Request $request, Organization $organization): JsonResponse
    {
        ...
        ActivityLog::record('organization.user_assigned', $organization, $validated, $request);
