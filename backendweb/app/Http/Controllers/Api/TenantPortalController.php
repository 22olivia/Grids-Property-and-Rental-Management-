...
class TenantPortalController extends Controller
{
    ...
    public function signLease(Request $request): JsonResponse
    {
        $tenant = $this->tenantOrFail($request);
        $lease = $this->activeLease($tenant);
        ...
        ActivityLog::record('tenant.lease.signed', $lease, ['tenant_id' => $tenant->id], $request);
    ...
    public function requestRenewal(Request $request): JsonResponse
    {
        ...
        $lease = $this->activeLease($tenant);
        abort_unless($lease, 404);
        ActivityLog::record('tenant.lease.renewal_requested', $lease, ['tenant_id' => $tenant->id], $request);
    ...
    public function submitNotice(Request $request): JsonResponse
    {
        $tenant = $this->tenantOrFail($request);
        $lease = $this->activeLease($tenant);
        abort_unless($lease, 404);
        $lease->update(['status' => 'notice_given']);
        ActivityLog::record('tenant.lease.notice_submitted', $lease, ['tenant_id' => $tenant->id], $request);
    ...
    public function uploadDocument(Request $request): JsonResponse
    {
        ...
        ActivityLog::record('tenant.document.uploaded', $doc, ['tenant_id' => $tenant->id], $request);

        return response()->json(['message' => 'Document uploaded.', 'data' => $doc], 201);
    }

    public function deleteDocument(Request $request, TenantDocument $document): JsonResponse
    {
        $tenant = $this->tenantOrFail($request);
        ...
        $document->delete();
        ActivityLog::record('tenant.document.deleted', $document, ['tenant_id' => $tenant->id], $request);
    ...
    public function updateProfile(Request $request): JsonResponse
    {
        ...
        ActivityLog::record('tenant.profile.updated', $tenant, [], $request);
    ...
    public function updateSettings(Request $request): JsonResponse
    {
        ...
        $tenant->save();
        ActivityLog::record('tenant.settings.updated', $tenant, [], $request);
