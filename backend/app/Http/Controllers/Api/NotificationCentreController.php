...
class NotificationCentreController extends Controller
{
    ...
    public function updatePreferences(Request $request, ActivityLogger $logger): JsonResponse
    {
        ...
        $logger->log('notification.preferences_updated', $prefs, $validated, $request);
    ...
    public function storeTemplate(Request $request, ActivityLogger $logger): JsonResponse
    {
        $user = $request->user();
        ...
        $logger->log('notification.template_saved', $template, $validated, $request);
    ...
    public function updateTemplate(Request $request, NotificationTemplate $template, ActivityLogger $logger): JsonResponse
    {
        $user = $request->user();
        ...
        $logger->log('notification.template_updated', $template, $validated, $request);
    ...
    public function updateChannel(Request $request, ActivityLogger $logger): JsonResponse
    {
        ...
        $logger->log('notification.channel_updated', $setting, $validated, $request);
