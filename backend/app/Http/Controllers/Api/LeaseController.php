...
class LeaseController extends Controller
{
    ...
    public function store(Request $request, LeaseService $leases, ActivityLogger $logger): JsonResponse
    {
        ...
        $logger->log('lease.created', $lease, $validated, $request);
    ...
    public function update(Request $request, Contract $lease, LeaseService $leases, ActivityLogger $logger): JsonResponse
    {
        ...
        $logger->log('lease.updated', $lease, $validated, $request);
    ...
    public function activate(Contract $lease, LeaseService $leases, InvoiceService $invoices, ActivityLogger $logger): JsonResponse
    {
        $leases->assertNoOverlap(
        ...
        $logger->log('lease.activated', $lease);
    ...
    public function terminate(Request $request, Contract $lease, ActivityLogger $logger): JsonResponse
    {
        ...
        $logger->log('lease.terminated', $lease, $validated, $request);
    ...
    public function renew(Request $request, Contract $lease, LeaseService $leases, ActivityLogger $logger): JsonResponse
    {
        $validated = $request->validate([
        ...
        $logger->log('lease.renewed', $renewal, ['from' => $lease->id], $request);
